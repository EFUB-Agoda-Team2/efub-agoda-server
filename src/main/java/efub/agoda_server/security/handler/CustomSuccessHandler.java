...
public class CustomSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public CustomSuccessHandler(JwtService jwtService) { this.jwtService = jwtService; }

    @Override
    public void onAuthenticationSuccess(HttpServletRequest req,
                                        HttpServletResponse res,
                                        Authentication auth) throws IOException {
        CustomOAuth2User u = (CustomOAuth2User) auth.getPrincipal();
        User user = u.getUser();
        ...
        userJson.put("profileImage", user.getProfileImg());
